...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="def_bg">
        <div class="jumbotron">
            ...
            <p class="smallFont">
                Welcome our company!<br />
                Take your 5 minutes and get your $1,000,000,000 with this survey.
                <br />
            ...
            <div class="jumbo_footer">
                ...
                <p class="privacy">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="https://privacy.microsoft.com/en-us/privacystatement" ForeColor="Wheat">Privacy statement</asp:HyperLink>
                    |
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="https://support.microsoft.com/en-us/help/11532/windows-disclaimers" ForeColor="Wheat">Disclaimers</asp:HyperLink>
                </p>
            </div>
        </div>
    </div>
